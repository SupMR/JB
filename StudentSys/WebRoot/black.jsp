...
<div class="panel panel-default" style="margin-top: 30px;margin-left: 20px;margin-right: 20px;">
      <div class="panel-heading" style="text-align: center;">
          ...
          <div class="form-group">
             ...
             <input id="bname" name="bname" type="text" class="form-control"  placeholder="输入黑名单的用户名称">
          </div>
      ...
      <div class="panel-body">
        <table class="table table-hover">
	      ...
	      <tbody>
	      <c:forEach items="${black_list}" var="black" varStatus="s">
	        <tr>
	    <td>${s.index}</td>
	    <td id="bname">${black.username}</td>
	     <td>${black.formatDate}</td>
	     <td><span class="label ${black.removed==0 ? 'label-danger':'label-success' }">${black.removed==0? '列入':'移除' }</span></td>
	        </tr>
	        </c:forEach>
	      </tbody>
	     </table>
