											...
											<div class="form-group">
												...
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														...
														id="Username" placeholder="Username" /> <i class="ace-icon fa fa-user"></i>
												</span>
												</label> 
												</div>
												<div class="form-group">
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														...
														id="password" placeholder="Password" /> <i class="ace-icon fa fa-lock"></i>
												</span>
												</label>
                                                </div>
												<div class="space"></div>
												...
												<div class="clearfix">
													<label class="inline"> <input type="checkbox"
														class="ace" /> <span><input class="lbl"
															type="checkbox" name="remember" value="1"/>自动登录</span>
													</label>
											...
											<div class="form-group">
													...
													<span
														class="block input-icon input-icon-right"> <input
															...
															id="password2" placeholder="确认密码" /> <i
